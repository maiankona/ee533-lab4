...
// /___/   /\     Timestamp : 02/01/2026 15:08:50
// \   \  /  \ 
//  \___\/\___\ 
//
//Command: C:\Xilinx\10.1\ISE\bin\nt\unwrapped\sch2verilog.exe -intstyle ise -family virtex2p -w C:/Xilinx/10.1/ISE/ISEexamples/lab3_testing/dropfifo.sch dropfifo.vf
...
module dropfifo(clk, 
   ...
   OR2 XLXI_13 (.I0(XLXN_8), 
                .I1(XLXN_3), 
                .O(XLXN_10));
   AND2B1 XLXI_14 (.I0(XLXN_36), 
                   .I1(XLXN_10), 
                   .O(XLXN_37));
   AND3B2 XLXI_15 (.I0(XLXN_31), 
                   .I1(XLXN_30), 
                   .I2(fiforead), 
                   .O(XLXN_34));
   VCC XLXI_16 (.P(XLXN_13));
   synch_mem_72 XLXI_17 (.addra(waddr[7:0]), 
                         .addrb(raddr[7:0]), 
                         .clka(clk), 
                         .clkb(clk), 
                         .dina(in_fifo0[71:0]), 
